import svgPaths from "./svg-8mpt32j8ui";
...
function Heading1() {
  return <div className="absolute h-[31.992px] left-0 top-0 w-[139.596px]" data-name="Heading 1" />;
}

function Container3() {
  return (
    <div className="absolute h-[32px] left-[250px] top-[785px] w-[526px]" data-name="Container">
      <Heading1 />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[520px] top-[1107px]">
      <div className="absolute bg-[#155dfc] h-[143px] left-[520px] opacity-76 rounded-[30px] top-[1107px] w-[460px]" />
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents left-[520px] top-[1107px]">
      <Group />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[681px] not-italic text-[48px] text-white top-[1153px] w-[285px]">Next</p>
    </div>
  );
}

function MaterialSymbolsMyLocation({ className }: { className?: string }) {
  return (
    <div className={className || "absolute left-[1163px] opacity-70 size-[73px] top-[871px]"} data-name="material-symbols:my-location">
      <div className="absolute inset-[4.37%]" data-name="Vector">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66.6125 66.6125">
          <path d={svgPaths.p1c890d00} fill="var(--fill-0, black)" id="Vector" style={{ fill: "black", fillOpacity: "1" }} />
        </svg>
      </div>
    </div>
  );
...
function Group1() {
  return (
    <div className="absolute contents left-[530px] top-[1326px]">
      <div className="absolute bg-[#155dfc] h-[143px] left-[530px] opacity-76 rounded-[30px] top-[1326px] w-[460px]" />
    </div>
  );
}

function Frame() {
  return <div className="absolute h-[52px] left-[560px] top-[1368px] w-[132px]" />;
}
...
export default function UserDataGathering() {
  return (
    <div className="bg-gradient-to-b from-[45.192%] from-[rgba(233,212,255,0.26)] relative shadow-[0px_0px_0px_0px_rgba(0,0,0,0.25)] size-full to-[rgba(140,127,153,0.26)]" data-name="user data gathering_4">
      <Container />
      <Paragraph />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[565px] not-italic text-[#6a7282] text-[32px] top-[620px] whitespace-nowrap">UV Protection Monitor</p>
      <Container2 />
      <Container3 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[250px] not-italic text-[#101828] text-[48px] top-[768px] w-[880px]">Enter your Location</p>
      <div className="absolute bg-white h-[143px] left-[237px] opacity-76 rounded-[30px] top-[836px] w-[1036px]" />
      <Group2 />
      <div className="absolute left-[791px] size-[66px] top-[1136px]" data-name="material-symbols:arrow-forward">
      ...
      <MaterialSymbolsMyLocation />
      <Group3 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[692px] not-italic text-[48px] text-white top-[1378px] whitespace-nowrap">Back</p>
    </div>
  );
}