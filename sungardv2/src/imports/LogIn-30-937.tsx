import svgPaths from "./svg-ihk5xezz75";
import img0B679656Ca7Ee45626D54E01C3C476B51 from "../../assets/74ceece163c51866dae49248c41b6607af7cf3a0.png";

function Heading() {
  return (
    <div className="absolute content-stretch flex h-[31.992px] items-start left-0 top-0 w-[139.596px]" data-name="Heading 1">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[32px] not-italic relative shrink-0 text-[96px] text-black w-[545px]">SunGuard</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="absolute h-[32px] left-[215px] top-[1177px] w-[526px]" data-name="Container">
      <Heading1 />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[488px] top-[1633px]">
      <div className="absolute bg-[#155dfc] h-[143px] left-[488px] opacity-76 rounded-[30px] top-[1633px] w-[460px]" />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute contents left-[488px] top-[1633px]">
      <Group />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[642px] not-italic text-[48px] text-white top-[1690px] w-[545px]">Log In</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[40px] leading-[0] left-[488px] not-italic text-[32px] text-black top-[1797px] w-[460px]">
        <span className="leading-[32px]">Click here for</span>
        <span className="leading-[32px] text-[#3d7bf9]">{` register account`}</span>
      </p>
    </div>
  );
}
...
export default function LogIn() {
  return (
    <div className="bg-gradient-to-b from-[39.904%] from-[rgba(233,212,255,0.26)] opacity-81 relative shadow-[0px_0px_0px_0px_rgba(0,0,0,0.25)] size-full to-[rgba(140,127,153,0.26)]" data-name="Log in">
      <div className="absolute h-[2113px] left-[-33px] top-0 w-[1501px]" data-name="0b679656ca7ee45626d54e01c3c476b5 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img0B679656Ca7Ee45626D54E01C3C476B51} />
      </div>
      <div className="absolute bg-[#d9d9d9] h-[2073px] left-[-47px] opacity-19 top-[-42px] w-[1516px]" />
      <Container />
      <Container2 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[215px] not-italic text-[48px] text-black top-[1160px] w-[545px]">Username</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[215px] not-italic text-[48px] text-black top-[1398px] w-[545px]">Password</p>
      <Paragraph />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[565px] not-italic text-[#030303] text-[32px] top-[1000px] whitespace-nowrap">UV Protection Monitor</p>
      <Container3 />
