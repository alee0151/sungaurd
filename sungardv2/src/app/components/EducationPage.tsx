      ...
      <div className="bg-white rounded-2xl border border-black/10 p-6">
          ...
          <div className="h-[280px] w-full min-w-0 min-h-0">
            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
              <LineChart data={cancerData} margin={{ top: 4, right: 8, bottom: 0, left: 10 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#E5E7EB" />
                <XAxis dataKey="year" tick={{ fontSize: 12, fill: "#6B7280" }} axisLine={{ stroke: "#6B7280" }} tickLine={{ stroke: "#6B7280" }} />
                <YAxis
        ...
        <div className="mt-4 pt-4 border-t border-black/5 grid grid-cols-3 gap-4">
          <div className="text-center">
            <p className="text-[#101828] text-[20px]" style={{ fontWeight: 700 }}>{firstCount.toLocaleString()}</p>
            <p className="text-[#6B7280] text-[12px]">{firstYear} cases</p>
          </div>
          <div className="text-center">
            <p className="text-[#EF4444] text-[20px]" style={{ fontWeight: 700 }}>+{growthPct}%</p>
            <p className="text-[#6B7280] text-[12px]">growth over period</p>
          </div>
          <div className="text-center">
            <p className="text-[#101828] text-[20px]" style={{ fontWeight: 700 }}>{lastCount.toLocaleString()}</p>
      ...
      <div className="bg-[#eff6ff] border border-[#bfdbfe] rounded-xl px-5 py-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-[#1e40af] text-[14px]">
            Melanoma incidence grew by {growthPct}% between {firstYear} and {lastYear}. Early detection and prevention through sun protection are crucial.
          </p>
        </div>
      </div>
